...
import { withNavigation, Routes } from '@kiwicom/margarita-navigation';
import { withAlertContext } from '@kiwicom/margarita-components';
  ...
  render() {
    ...
    return (
      <>
        ...
        {Platform.OS === 'mobile' && <View style={styles.bottomSpacer} />}
        <SearchModal />
      </>
    );
  }
